...
export const COMMAND_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    tier: 'coordination',
    owner: 'orchestrator',
    description: 'Pull memory in from another tool (claude-mem, cursor-rules)',
    aliases: [],
    since: '1.4.0',
    status: 'active',
  },
  ...
  },
  {
    ...
    since: '1.4.0',
    status: 'deprecated',
    deprecatedReason: 'Open the dashboard with: ijfw dashboard start. Agent-side metrics are available through ijfw_metrics.',
  },
  {
    name: 'mode',
    tier: 'pointer-stub',
