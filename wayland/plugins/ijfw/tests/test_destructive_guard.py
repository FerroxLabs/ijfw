#!/usr/bin/env python3
"""test_destructive_guard.py -- pre_tool_call blocks destructive cmds; safe cmds pass."""
...
def test_non_terminal_tool_not_blocked():
    ctx = setup()
    # Even a dangerous-looking args dict on a non-terminal tool should pass.
...
def test_message_truncated_at_80():
    ...
    # The cmd portion in the message should be at most 80 chars.
    # Find the segment after ": " to locate the cmd snippet.
