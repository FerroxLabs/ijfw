...
test('gemini: agents/ directory exists (project agents are generated by Team Assembly)', () => {
  // v1.5.1 medlow audit: the 3 orphan agent specs (architect/builder/scout)
  // were removed for parity with the claude/ removal — they were never
  // referenced by any skill, hook, or swarm-config. Gemini ships no
  // platform-shipped agent templates; project agents are produced at runtime
  // by Team Assembly, the same as Codex.
